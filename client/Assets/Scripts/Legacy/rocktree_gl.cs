...
public class rocktree_gl : MonoBehaviour
{
	...
	public static void bindAndDrawMesh(Camera camera, Material material, rocktree_t.node_t.mesh_t mesh, UnityEngine.Matrix4x4 transform_float, byte mask_map)
    {
		...
		block.SetFloatArray("octant_mask", new List<float> { mask_map & 0b10000000, mask_map & 0b01000000, mask_map & 0b00100000, mask_map & 0b00010000, mask_map & 0b00001000, mask_map & 0b00000100, mask_map & 0b00000010, mask_map & 0b00000001 });
