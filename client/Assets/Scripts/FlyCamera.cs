...
public class FlyCamera : MonoBehaviour
{
    ...
    private UnityEngine.Vector3 lastMouse = new UnityEngine.Vector3(255, 255, 255); //kind of in the middle of the screen, rather than at the top (play)
    ...
    void Update()
    {
        ...
        //Keyboard commands
        float f = 0.0f;
        UnityEngine.Vector3 p = GetBaseInput();
        if (p.sqrMagnitude > 0)
    ...
    { //returns the basic values, if it's 0 than it's not active.
        ...
        {
            p_Velocity += new UnityEngine.Vector3(-1, 0, 0);
        }
